        ...
        <Modal.Body>
          <Form onSubmit={(e) => this.props.addComment(e, this.state.user_rating, this.state.comment, this.props.movieId, this.props.email)}>
            <Form.Group controlId="title">
              ...
              <Form.Control type="text" placeholder="Comment Here" onChange={this.updateUserComment}/>
            </Form.Group>

            <Form.Group controlId="rating">
              <Form.Label>Rating</Form.Label>
              <Form.Control as="select" type="number" placeholder="User Rating" onChange={this.updateUserRating}>
                <option>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>
